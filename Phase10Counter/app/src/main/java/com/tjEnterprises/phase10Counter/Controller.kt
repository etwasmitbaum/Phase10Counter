...
class Controller {
    ...
    fun placePlayerFragments() {
        if (mainActivity.resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            placePlayerFragmentsForLandscape()
        } else {
            placePlayerFragmentsForPortrait()
        }
    }

    private fun placePlayerFragmentsForPortrait() {
        val llFragments: LinearLayout = mainActivity.findViewById(R.id.llFragmentHolder)
        llFragments.removeAllViews()
    ...
    private fun placePlayerFragmentsForLandscape() {
        val llFragments: LinearLayout = mainActivity.findViewById(R.id.llFragmentHolder)
        llFragments.removeAllViews()

        val secondLLFragmentsForLandscape: LinearLayout =
            mainActivity.findViewById(R.id.secondLLFragmentHolderForLandscape)
        secondLLFragmentsForLandscape.removeAllViews()
        ...
        for (i in 0 until firstHalf.toInt()) {
        ...
        for (i in firstHalf.toInt() until players.size) {
