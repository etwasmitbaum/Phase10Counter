...
class PlayerRecyclerAdapter(
    private val player: MutableList<Player> = ArrayList(),
    private val controller: Controller
) : RecyclerView.Adapter<PlayerRecyclerAdapter.ViewHolder>() {
    class ViewHolder(itemView: View, private val con: Controller) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.fragment_player, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val adpater = ArrayAdapter<Int>(
            controller.appContext,
            R.layout.point_history_spinner,
            player[position].getPunkteList()
        )
